...
export function RoomsView({ user, allRoomConfigs, initialProperty }: RoomsViewProps) {
    ...
    const roomsData = useMemo(() => {
        ...
        return ROOM_ORDER.map(id => {
            ...
            const mejorasEnCola = colaConstruccion.filter(c => c.habitacionId === id);
            ...
            const construccionActiva = colaConstruccion.find(c => c.habitacionId === id && c.fechaFinalizacion);
